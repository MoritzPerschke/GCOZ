...
#define COUNT_EVERY_SECOND_(_1,__1,_2,__2,_3,__3,_4,__4,_5,__5,_6,__6,_7,__7,_8,__8,_9,__9,_10,__10,_11,__11, num,...) EVERY_SECOND##num
#define PARAMETER_NAMES(...) COUNT_EVERY_SECOND_(__VA_ARGS__,11,11,10,10,9,9,8,8,7,7,6,6,5,5,4,4,3,3,2,2,1,0)(__VA_ARGS__)
...
#define COUNT_EVERY_FIRST_(_1,__1,_2,__2,_3,__3,_4,__4,_5,__5,_6,__6,_7,__7,_8,__8,_9,__9,_10,__10,_11,__11, num,...) EVERY_FIRST##num
#define PARAMETER_TYPES(...) COUNT_EVERY_FIRST_(__VA_ARGS__, 11,11,10,10,9,9,8,8,7,7,6,6,5,5,4,4,3,3,2,2,1,1,0)(__VA_ARGS__)
...
#define COUNT_ALL_(_1, __1, _2, __2, _3, __3, _4, __4, _5, __5, _6, __6, _7, __7, _8, __8, _9, __9, _10, __10, _11, __11, num, ...) ALL##num
#define FUNCTION_SIGNATURE(...) COUNT_ALL_(__VA_ARGS__, 11,11,10,10,9,9,8,8,7,7,6,6,5,5,4,4,3,3,2,2,1,0)(__VA_ARGS__)
...
#define D3D11_METHODS \
	...
	X(175, HRESULT, FinishCommandList, ID3D11DeviceContext*, pContext, BOOL, RestoreDeferredContextState, ID3D11CommandList**, ppCommandList)\
	X(195, HRESULT, UpdateTileMappings, ID3D11DeviceContext2*, pContext, ID3D11Resource*, pTiledResource, UINT, NumTiledResourceRegions, const D3D11_TILED_RESOURCE_COORDINATE*, pTiledResourceRegionStartCoordinates, const D3D11_TILE_REGION_SIZE*, pTiledResourceRegionSizes, ID3D11Buffer*, pTilePool, UINT, NumRanges, const UINT*, pRangeFlags, const UINT*, pTilePoolStartOffsets, const UINT*, pRangeTileCounts, UINT, Flags)\
...
#define D3D11_METHODS_VOID \
	...
	X(176, void, CopySubresourceRegion1, ID3D11DeviceContext1*, pContext, ID3D11Resource*, pDstResource, UINT, DstSubresource, UINT, DstX, UINT, DstY, UINT, DstZ, ID3D11Resource*, pSrcResource, UINT, SrcSubresource, const D3D11_BOX*, pSrcBox, UINT, CopyFlags)\
	X(177, void, UpdateSubresource1, ID3D11DeviceContext1*, pContext, ID3D11Resource*, pDstResource, UINT, DstSubresource, const D3D11_BOX*, pDstBox, const void*, pSrcData, UINT, SrcRowPitch, UINT, SrcDepthPitch, UINT, CopyFlags)\
	...
	X(180, void, VSSetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(181, void, HSSetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(182, void, DSSetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(183, void, GSSetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(184, void, PSSetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(185, void, CSSetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(186, void, VSGetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(187, void, HSGetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(188, void, DSGetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(189, void, GSGetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(190, void, PSGetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(191, void, CSGetConstantBuffers1, ID3D11DeviceContext1*, pContext, UINT, StartSlot, UINT, NumBuffers, ID3D11Buffer *const*, ppConstantBuffers, const UINT*, pFirstConstant, const UINT*, pNumConstants)\
	X(192, void, SwapDeviceContextState, ID3D11DeviceContext1*, pContext, ID3DDeviceContextState*, pState, ID3DDeviceContextState**, ppPreviousState)\
	X(193, void, ClearView, ID3D11DeviceContext1*, pContext, ID3D11View*, pView, const FLOAT*, Color, const D3D11_RECT*, pRect, UINT, NumRects)\
	X(194, void, DiscardView1, ID3D11DeviceContext1*, pContext, ID3D11View*, pView, const D3D11_RECT*, pRects, UINT, NumRects)\
	...
	X(200, void, TiledResourceBarrier, ID3D11DeviceContext2*, pContext, ID3D11DeviceChild*, pTiledResourceOrViewAccessBeforeBarrier, ID3D11DeviceChild*, pTiledResourceOrViewAccessAfterBarrier)\
